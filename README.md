...
* **Flow:** [문서 입력] -> [RAG 청킹 최적화 및 적재] -> [사용자 질의 패턴 분석] -> [프롬프트 가드레일 통과] -> [안전한 컨텍스트 합성]
* **배경 & 도전 과제 (Problem & Challenge)**
...
* **Tech Stack:** `Python` · `LangChain` · `Pydantic Guardrails` · `VectorDB`
...
* **Tech Stack:** `Python` · `PyTorch` · `Hugging Face (Transformers)` · `scikit-learn`
